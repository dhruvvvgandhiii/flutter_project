...
class ApiClient {
  ...
  /// Performs API call for https://demoapiwisegpt.dhiwise.co/device/auth/register
  ///
  /// Sends a POST request to the server's 'https://demoapiwisegpt.dhiwise.co/device/auth/register' endpoint
